...
const Footer = () => {
    return (
      <footer className="mt-10 bg-green-700 text-white border-t body-font">
        <div className="container flex flex-col flex-wrap p-5 mx-auto md:items-center lg:items-start md:flex-row md:flex-no-wrap ">
          <div className="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
            ...
            <p className="mt-6 text-xs text-center text-white">
              Wicked Templates helps you jumpstart a landing page by providing
              you with swapable sections.
            </p>
          </div>
        ...
        <div className="bg-greenGray-900">
          <div className="container flex flex-col flex-wrap px-5 py-6 mx-auto sm:flex-row">
            ...
            <span className="inline-flex justify-center mt-2 sm:ml-auto sm:mt-0 sm:justify-start">
              ...
              <Link to="#" className="ml-4 text-white hover:text-green-500">
                <svg
                  fill="currentColor"
                  stroke-linecap="round"
                  stroke-linejoin="round"
